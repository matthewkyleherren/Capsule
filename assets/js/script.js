    ...
    var Li = u(() => {
        window.tram = function (e) {
            ...
            function c(l, E, g) {
                ...
                var T = g;
                return qi.test(l) || !tn.test(l) ? T = parseInt(l, 10) : tn.test(l) && (T = 1e3 * parseFloat(l)), 0 > T && (T = 0), T === T ? T : g
            }
            ...
            var d = function (l, E, g) {
                    ...
                    function W(Q, le) {
                        ...
                        var ie, ye = m[l] = Q[l],
                            $e = ne[l] = U[l] = new m;
                        return $e.constructor = U, U.mixin = function (we) {
                            return ne[l] = U[l] = W(U, we)[l], U
                        }, U.open = function (we) {
                            if (ie = {}, h(we) ? ie = we.call(U, $e, ye, U, Q) : T(we) && (ie = we), T(ie))
                                for (var _r in ie) E.call(ie, _r) && ($e[_r] = ie[_r]);
            ...
            var L = t.frame = function () {
                ...
                B = d(function (l) {
                        ...
                        if (k) {
                            ...
                            if (ue == "object") {
                                ...
                                $e.call(this, k, function (Ie, nI) {
                                    Ie.span > Ce && (Ce = Ie.span), Ie.stop(), Ie.animate(nI)
                                }, function (Ie) {
                                    "wait" in Ie && (Ce = c(Ie.wait, 0))
                                }), ye.call(this), Ce > 0 && (this.timer = new pe({
                                    duration: Ce,
                                    context: this
                                }), this.active = !0, se && (this.timer.complete = m));
                                var Ue = this,
                                    Pe = !1,
                                    rn = {};
                                L(function () {
                    ...
                    function Q(k) {
                        W.call(this, k), $e.call(this, k, _r, tI)
                    }
                    ...
                    function $e(k, se, Ee) {
                        var ue, Ce, Ue, Pe, rn = se !== we,
                            Ie = {};
                        for (ue in k) Ue = k[ue], ue in Ye ? (Ie.transform || (Ie.transform = {}), Ie.transform[ue] = Ue) : (R.test(ue) && (ue = r(ue)), ue in gr ? Ie[ue] = Ue : (Pe || (Pe = {}), Pe[ue] = Ue));
                        for (ue in Ie) {
                    ...
                    function Xe(k, se) {
                        l[k] = function () {
                            return this.children ? rI.call(this, se, arguments) : (this.el && se.apply(this, arguments), this)
                        }
                    }
                    ...
                    }, Xe("add", E), Xe("start", g), Xe("wait", T), Xe("then", h), Xe("next", m), Xe("stop", W), Xe("set", Q), Xe("show", le), Xe("hide", U), Xe("redraw", ne), Xe("destroy", ie)
                }),
                X = d(B, function (l) {
                    function E(g, T) {
                ...
                F = d(function (l) {
                    ...
                    l.init = function (m, W, Q, le) {
                        ...
                        m = this.convert(m, this.type), this.auto && (W == "auto" && (W = this.convert(this.get(), this.type)), m == "auto" && (m = E.call(this))), this.tween = new z({
                            from: W,
                            to: m,
                        ...
                        switch (W) {
                            ...
                            case q:
                                if (U) {
                                    ...
                                    if (W.test(m)) return m.charAt(0) == "#" && m.length == 7 ? m : T(m)
                                }
                                Q = "hex or rgb string";
                                break;
                            case w:
                                if (le) return m + this.unit;
                            ...
                            case C:
                                ...
                                break;
                            case D:
                                if (le) return m + this.angle;
                                if (U && W.test(m)) return m;
                                Q = "number(deg) or string(angle)";
                                break;
                            case H:
                                if (le || U && C.test(m)) return m;
                ...
                oe = d(F, function (l, E) {
                    function g(T, h) {
                        var m, W, Q, le, U;
                        for (m in T) le = Ye[m], Q = le[0], W = le[1] || m, U = this.convert(T[m], Q), h.call(this, W, U, Q)
                    }
                    l.init = function () {
                        E.init.apply(this, arguments), this.current || (this.current = {}, Ye.perspective && _e.perspective && (this.current.perspective = _e.perspective, pt(this.el, this.name, this.style(this.current)), this.redraw()))
                    }, l.set = function (T) {
                        g.call(this, T, function (h, m) {
                            this.current[h] = m
                        }), pt(this.el, this.name, this.style(this.current)), this.redraw()
                        ...
                        return g.call(this, T, function (W, Q, le) {
                            m[W] = Q, this.current[W] === void 0 && (h = 0, ~W.indexOf("scale") && (h = 1), this.current[W] = this.convert(h, le))
                        }), m
                    }
                }),
                z = d(function (l) {
                    ...
                    function g() {
                        ...
                        if (ye)
                            for (L(g), ne = V(), U = ye; U--;) ie = Q[U], ie && ie.render(ne)
                    }
                    ...
                    l.init = function (U) {
                        ...
                        if (ie < this.duration) {
                            ...
                            return ne = this.startRGB ? m(this.startRGB, this.endRGB, ye) : h(this.begin + ye * this.change), this.value = ne + this.unit, void this.update.call(this.context, this.value)
                        }
                ...
                Ft = d(z, function (l, E) {
                    l.init = function (g) {
                        ...
                        var T, h, m = this.tweens.length,
                            W = !1;
                        for (T = m; T--;) h = this.tweens[T], h.context && (h.render(g), this.current[h.name] = h.value, W = !0);
            ...
            var pt = e.style,
                ...
                Ye = {};
            G.transform && (gr.transform = [oe], Ye = {
                x: [C, "translateX"],
                y: [C, "translateY"],
                rotate: [D],
                rotateX: [D],
                ...
                skewX: [D],
                skewY: [D]
            }), G.transform && G.backface && (Ye.z = [C, "translateZ"], Ye.rotateZ = [D], Ye.scaleZ = [I], Ye.perspective = [w]);
            var qi = /ms/,
                tn = /s|\./;
            return e.tram = t
        }(window.jQuery)
        ...
        Es.exports = function () {
            ...
            e.map = e.collect = function (_, P, M) {
                ...
                return D(_, function (K, Z, L) {
                    if (P.call(M, K, Z, L)) return G = K, !0
                }), G
            ...
            var D = e.some = e.any = function (_, P, M) {
                ...
                return _ == null ? G : N && _.some === N ? _.some(P, M) : (C(_, function (K, Z, L) {
                    if (G || (G = P.call(M, K, Z, L))) return t
                }), !!G)
            };
            e.contains = e.include = function (_, P) {
                ...
                var P, M, G;
                return function () {
                    P || (P = !0, M = arguments, G = this, aI.frame(function () {
                        P = !1, _.apply(G, M)
                    }))
                }
                ...
                var G, K, Z, L, V, B = function () {
                    var X = e.now() - L;
                    X < P ? G = setTimeout(B, P - X) : (G = null, M || (V = _.apply(Z, K), Z = K = null))
                };
                return function () {
                    Z = this, K = arguments, L = e.now();
                    var X = M && !G;
                    return G || (G = setTimeout(B, P)), X && (V = _.apply(Z, K), Z = K = null), V
                }
                ...
                if (q) return q(_);
                var P = [];
                for (var M in _) e.has(_, M) && P.push(M);
                return P
            }, e.has = function (_, P) {
                return f.call(_, P)
            ...
            return e.template = function (_, P, M) {
                ...
                _.replace(G, function (X, F, Y, ae, oe) {
                    return Z += _.slice(K, oe).replace(re, $), K = oe + X.length, F ? Z += `'+
...
` + Z + "}", B
    ...
    var Ze = u((ZV, Ss) => {
        ...
        function ys(e) {
            ce.env() && (Qe(e.design) && Be.on("__wf_design", e.design), Qe(e.preview) && Be.on("__wf_preview", e.preview)), Qe(e.destroy) && Be.on("__wf_destroy", e.destroy), e.ready && Qe(e.ready) && sI(e)
        }
        ...
        function Is(e) {
            Qe(e.design) && Be.off("__wf_design", e.design), Qe(e.preview) && Be.off("__wf_preview", e.preview), Qe(e.destroy) && Be.off("__wf_destroy", e.destroy), e.ready && Qe(e.ready) && uI(e)
        }
        ...
        ce.ready = function () {
            an = !0, Mi ? dI() : Ve.each(Xt, gs), Ve.each(xi, gs), ce.resize.up()
        };
        ...
        ce.destroy = function (e) {
            e = e || {}, Mi = !0, Be.triggerHandler("__wf_destroy"), e.domready != null && (an = e.domready), Ve.each(Gt, Is), ce.resize.off(), ce.scroll.off(), ce.redraw.off(), Xt = [], xi = [], St.state() === "pending" && Os()
        };
        vt(ce.ready);
        Os();
    ...
    var Rs = u((JV, bs) => {
        ...
        As.define("brand", bs.exports = function (e) {
            ...
            t.ready = function () {
                ...
                /\.webflow\.io$/i.test(S) && o.hostname !== S && (y = !0), y && !s && (f = f || d(), v(), setTimeout(v, 500), e(r).off(c, p).on(c, p))
            };
    ...
    var Cs = u((eB, ws) => {
        ...
        Fi.define("edit", ws.exports = function (e, t, r) {
            if (r = r || {}, (Fi.env("test") || Fi.env("frame")) && !r.fixture && !pI()) return {
                exit: 1
            };
            var n = {},
                i = e(window),
            ...
            function v() {
                c = !0, window.WebflowEditor = !0, i.off(s, d), R(function (q) {
                    e.ajax({
            ...
            function y(q) {
                return function (w) {
                    ...
                    w.thirdPartyCookiesSupported = q, S(N(w.bugReporterScriptPath), function () {
            ...
            function R(q) {
                ...
                var C = function (D) {
                    D.data === "WF_third_party_cookies_unsupported" ? (I(w, C), q(!1)) : D.data === "WF_third_party_cookies_supported" && (I(w, C), q(!0))
                };
                w.onerror = function () {
                    I(w, C), q(!1)
    ...
    var qs = u((tB, Ns) => {
        ...
        vI.define("focus-visible", Ns.exports = function () {
            function e(r) {
                ...
                function S(I) {
                    s(I.target) && I.target.hasAttribute("data-wf-focus-visible") && (i = !0, window.clearTimeout(a), a = window.setTimeout(function () {
                        i = !1
                    }, 100), p(I.target))
                }
                ...
                document.addEventListener("keydown", d, !0), document.addEventListener("mousedown", v, !0), document.addEventListener("pointerdown", v, !0), document.addEventListener("touchstart", v, !0), document.addEventListener("visibilitychange", O, !0), N(), r.addEventListener("focus", y, !0), r.addEventListener("blur", S, !0)
            }
    ...
    var xs = u((rB, Ps) => {
        ...
        Ls.define("focus", Ps.exports = function () {
            ...
            function a() {
                typeof document < "u" && document.body.hasAttribute("data-wf-focus-within") && Ls.env.safari && (document.addEventListener("mousedown", i, !0), document.addEventListener("mouseup", r, !0), document.addEventListener("click", r, !0))
            }
            return {
                ready: a
            }
    ...
    var Bs = u((aB, ut) => {
        function Ui(e) {
            ...
            }, ut.exports.__esModule = !0, ut.exports.default = ut.exports, Ui(e)
        }
        ut.exports = Ui, ut.exports.__esModule = !0, ut.exports.default = ut.exports
    });
    var Ut = u((oB, yr) => {
        var gI = Bs().default;
        ...
        function _I(e, t) {
            ...
            if (e === null || gI(e) !== "object" && typeof e != "function") return {
                default: e
            };
            var r = Ws(t);
        ...
        yr.exports = _I, yr.exports.__esModule = !0, yr.exports.default = yr.exports
    });
    var et = u((sB, Ir) => {
        function yI(e) {
        ...
        Ir.exports = yI, Ir.exports.__esModule = !0, Ir.exports.default = Ir.exports
    });
    var ve = u((uB, Hs) => {
        var cn = function (e) {
    ...
    var ji = u((gB, ou) => {
        ...
        ou.exports = function (e) {
            if (e == null) throw qI("Can't call method on " + e);
            return e
        }
    });
    var mr = u((_B, su) => {
    ...
    var Tu = u((SB, Iu) => {
        var yu = ve(),
            ...
            _u = gu && gu.v8,
            He, fn;
        _u && (He = _u.split("."), fn = He[0] > 0 && He[0] < 4 ? 1 : +(He[0] + He[1]));
    ...
    var ec = u((UB, Ju) => {
        ...
        Ju.exports = function (e, t) {
            ...
            var r = OT(e, RT),
                n;
            if (r) {
                if (t === void 0 && (t = "default"), n = mT(r, e, t), !Qu(n) || Zu(n)) return n;
                throw bT("Can't convert object to primitive value")
            }
            return t === void 0 && (t = "number"), ST(e, t)
        }
    });
    var na = u((VB, tc) => {
        var wT = ec(),
    ...
    var sa = u(oc => {
        ...
        oc.f = MT ? ac : function (t, r) {
            if (t = XT(t), r = UT(r), BT) try {
                return ac(t, r)
            } catch {}
            if (VT(t, r)) return GT(!DT(FT.f, t, r), t[r])
        }
    });
    var Sr = u((jB, uc) => {
        var sc = ve(),
    ...
    var Ac = u((ZB, Sc) => {
        var um = hc(),
            ...
            Ea = Oc.TypeError,
            pm = Oc.WeakMap,
            hn, br, gn, vm = function (e) {
                return gn(e) ? br(e) : hn(e, {})
            },
            Em = function (e) {
                return function (t) {
                    var r;
                    if (!cm(t) || (r = br(t)).type !== e) throw Ea("Incompatible receiver, " + e + " required");
                    return r
                }
            };
        um || pa.state ? (ht = pa.state || (pa.state = new pm), Tc = fa(ht.get), va = fa(ht.has), mc = fa(ht.set), hn = function (e, t) {
            if (va(ht, e)) throw new Ea(Ic);
            return t.facade = e, mc(ht, e, t), t
        }, br = function (e) {
            return Tc(ht, e) || {}
        }, gn = function (e) {
            return va(ht, e)
        }) : (Rt = fm("state"), dm[Rt] = !0, hn = function (e, t) {
            if (da(e, Rt)) throw new Ea(Ic);
            return t.facade = e, lm(e, Rt, t), t
        }, br = function (e) {
            return da(e, Rt) ? e[Rt] : {}
        }, gn = function (e) {
            return da(e, Rt)
    ...
    var Pc = u((eW, Lc) => {
        ...
        (Lc.exports = function (e, t, r, n) {
            var i = n ? !!n.unsafe : !1,
                ...
                c;
            if (Cc(r) && (String(s).slice(0, 7) === "Symbol(" && (s = "[" + String(s).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), (!Tm(r, "name") || Sm && r.name !== s) && Nc(r, "name", s), c = bm(r), c.source || (c.source = Rm.join(typeof s == "string" ? s : ""))), e === Im) {
                a ? e[t] = r : mm(t, r);
                return
    ...
    var Ta = u((oW, Hc) => {
        ...
        Hc.exports = function (e, t) {
            var r = Um(e),
                ...
                i = [],
                a;
            for (a in r) !Ia(Bm, a) && Ia(r, a) && Wc(i, a);
            for (; t.length > n;) Ia(r, a = t[n++]) && (~Vm(i, a) || Wc(i, a));
            return i
        }
    });
    var _n = u((sW, jc) => {
    ...
    var nl = u((pW, rl) => {
        ...
        rl.exports = function (e, t) {
            var r = e.target,
                ...
                i = e.stat,
                a, o, s, c, f, p;
            if (n ? o = ma : i ? o = ma[r] || dO(r, {}) : o = (ma[r] || {}).prototype, o)
                for (s in t) {
                    if (f = t[s], e.noTargetGet ? (p = cO(o, s), c = p && p.value) : c = o[s], a = vO(n ? s : r + (i ? "." : "#") + s, e.forced), !a && c !== void 0) {
                        if (typeof f == typeof c) continue;
                        pO(f, c)
                    }(e.sham || c && c.sham) && lO(f, "sham", !0), fO(o, s, f, e)
                }
        }
    });
    var al = u((vW, il) => {
    ...
    var sl = u((EW, ol) => {
        ...
        ol.exports = gO ? Object.defineProperties : function (t, r) {
            yO(t);
            for (var n = IO(r), i = TO(r), a = i.length, o = 0, s; a > o;) _O.f(t, s = i[o++], n[s]);
            return t
        }
    });
    var cl = u((hW, ul) => {
        ...
        var OO = Sr(),
            ...
            CO = function () {
                var e = RO("iframe"),
                    t = "java" + Aa + ":",
                    r;
                return e.style.display = "none", bO.appendChild(e), e.src = String(t), r = e.contentWindow.document, r.open(), r.write(El("document.F=Object")), r.close(), r.F
            },
            yn, In = function () {
                try {
                ...
                for (var e = ll.length; e--;) delete In[Sa][ll[e]];
                return In()
            };
        AO[vl] = !0;
        hl.exports = Object.create || function (t, r) {
            var n;
            return t !== null ? (Oa[Sa] = OO(t), n = new Oa, Oa[Sa] = null, n[vl] = t) : n = In(), r === void 0 ? n : SO(n, r)
        }
    });
    var yl = u((_W, _l) => {
        var NO = ra(),
    ...
    var Ma = u(Cr => {
        ...
        function Ql(e, t, r) {
            ...
            function v(O) {
                if (!(0, OS.default)(O)) throw new Error("Actions must be plain objects. Use custom middleware for async actions.");
            ...
            return function (n) {
                return function (i, a, o) {
                    ...
                    return f = t.map(function (d) {
                        return d(p)
                    }), c = MS.default.apply(void 0, f)(s.dispatch), PS({}, s, {
                        dispatch: c
                    })
                }
            }
    ...
    var ff = u(Sn => {
        ...
        var Gb = xe(),
            {
                IX2_RAW_DATA_IMPORTED: Xb
            } = Gb.IX2EngineActionTypes,
    ...
    var Nr = u((e5, lt) => {
        function Ya() {
            return lt.exports = Ya = Object.assign ? Object.assign.bind() : function (e) {
                ...
                return e
            }, lt.exports.__esModule = !0, lt.exports.default = lt.exports, Ya.apply(this, arguments)
        }
        lt.exports = Ya, lt.exports.__esModule = !0, lt.exports.default = lt.exports
    });
    var zt = u(he => {
        "use strict";
                ...
                if (f != null) {
                    ...
                    if (p.length)
                        for (var d = 0; d <= p.length; d++) {
                            ...
                            if (!(e && n[v] !== void 0)) {
                                var y = f[v];
                                t && An(n[v]) && An(y) && (y = Me(e, t, n[v], y)), !(y === void 0 || y === n[v]) && (i || (i = !0, n = bn(n)), n[v] = y)
                            }
                        }
                }
            }
        ...
        function bf(e, t, r, n, i, a, o) {
            ...
            return p.length ? c = Me.call.apply(Me, [null, !1, !1, s, r, n, i, a, o].concat(p)) : c = Me(!1, !1, s, r, n, i, a, o), Cn(e, t, c)
        }
    ...
    var Nf = u(Nn => {
        ...
        var jb = Hb(Nr()),
            ...
            Kb = zt(),
            {
                IX2_PREVIEW_REQUESTED: zb,
                IX2_PLAYBACK_REQUESTED: Yb,
                IX2_STOP_REQUESTED: $b,
                IX2_CLEAR_REQUESTED: Qb
            } = kb.IX2EngineActionTypes,
            Zb = {
                preview: {},
                playback: {},
                stop: {},
            ...
            Jb = (e = Zb, t) => {
                if (t.type in Cf) {
                    let r = [Cf[t.type]];
                    return (0, Kb.setIn)(e, [r], (0, jb.default)({}, t.payload))
                }
                return e
            };
        Nn.ixRequest = Jb
    ...
    var Ad = u((N5, Sd) => {
        ...
        function qR(e, t) {
            var r = this.__data__;
            return this.size += this.has(e) ? 0 : 1, r[e] = CR && t === void 0 ? NR : t, this
        }
        Sd.exports = qR
    });
    var Rd = u((q5, bd) => {
    ...
    var Hd = u((U5, Wd) => {
        ...
        function ow(e, t) {
            ...
            if (r instanceof rw) {
                var n = r.__data__;
                if (!nw || n.length < aw - 1) return n.push([e, t]), this.size = ++r.size, this;
    ...
    var Qd = u((H5, $d) => {
        ...
        function Mn(e) {
            var t = -1,
                r = e == null ? 0 : e.length;
            for (this.__data__ = new hw; ++t < r;) this.add(e[t])
        }
    ...
    var to = u((K5, rp) => {
        ...
        function bw(e, t, r, n, i, a) {
            ...
            for (a.set(e, t), a.set(t, e); ++d < s;) {
                var S = e[d],
                    O = t[d];
                if (n) var N = o ? n(O, S, d, t, e, a) : n(S, O, d, e, t, a);
                if (N !== void 0) {
                    if (N) continue;
                    v = !1;
                    break
                ...
                if (y) {
                    if (!mw(t, function (b, R) {
                            if (!Ow(y, R) && (S === b || i(S, b, r, n, a))) return y.push(R)
                        })) {
                        v = !1;
                        break
                    }
    ...
    var pp = u((Q5, dp) => {
        ...
        function zw(e, t, r, n, i, a, o) {
            switch (r) {
                ...
                case Ww:
                    var c = n & Mw;
                    if (s || (s = xw), e.size != t.size && !c) return !1;
                    var f = o.get(e);
                    if (f) return f == t;
                    n |= Dw, o.set(e, t);
    ...
    var ao = u((nH, Tp) => {
        var rC = _p(),
            ...
            oC = Ip ? function (e) {
                return e == null ? [] : (e = Object(e), rC(Ip(e), function (t) {
                    return aC.call(e, t)
                }))
            } : nC;
        Tp.exports = oC
    ...
    var Gn = u((uH, xp) => {
        ...
        function SC(e, t) {
            var r = typeof e;
            return t = t ? ? mC, !!t && (r == "number" || r != "symbol" && OC.test(e)) && e > -1 && e % 1 == 0 && e < t
        }
        xp.exports = SC
    });
    var Xn = u((cH, Mp) => {
    ...
    var so = u((pH, jp) => {
        ...
        function hN(e, t) {
            var r = lN(e),
                ...
                c = s.length;
            for (var f in e)(t || EN.call(e, f)) && !(o && (f == "length" || i && (f == "offset" || f == "parent") || a && (f == "buffer" || f == "byteLength" || f == "byteOffset") || dN(f, c))) && s.push(f);
            return s
        }
        jp.exports = hN
    });
    ...
    var Bn = u((hH, Yp) => {
        ...
        function AN(e) {
            if (!TN(e)) return mN(e);
            var t = [];
            for (var r in Object(e)) SN.call(e, r) && r != "constructor" && t.push(r);
            return t
        }
        Yp.exports = AN
    });
    ...
    var rv = u((IH, tv) => {
        ...
        function UN(e, t, r, n, i, a) {
            ...
            for (var N = o; ++d < c;) {
                ...
                var b = e[v],
                    R = t[v];
                if (n) var I = o ? n(R, b, v, t, e, a) : n(b, R, v, e, t, a);
    ...
    var Sv = u((bH, Ov) => {
        ...
        function fq(e, t, r, n, i, a) {
            ...
            if (v && !p) return a || (a = new Eo), o || uq(e) ? aq(e, t, r, n, i, a) : oq(e, t, c, r, n, i, a);
            if (!(r & cq)) {
                ...
                if (y || S) {
                    var O = y ? e.value() : e,
                        N = S ? t.value() : t;
                    return a || (a = new Eo), i(O, N, r, n, a)
                }
            }
            return v ? (a || (a = new Eo), sq(e, t, r, n, i, a)) : !1
        }
        Ov.exports = fq
    });
    var ho = u((RH, Rv) => {
        ...
        function gq(e, t, r, n) {
            ...
            for (; ++i < a;) {
                ...
                if (o && s[2]) {
                    ...
                    if (!(v === void 0 ? vq(p, f, Eq | hq, n, d) : v)) return !1
                }
            }
            return !0
        }
    ...
    var Uv = u((MH, Xv) => {
        ...
        function yo(e, t) {
            ...
            return r.cache = new(yo.Cache || Gv), r
        }
        yo.Cache = Gv;
        Xv.exports = yo
    });
    ...
    var Hv = u((FH, Wv) => {
        var Vq = Bv(),
            ...
            Hq = Vq(function (e) {
                var t = [];
                return e.charCodeAt(0) === 46 && t.push(""), e.replace(Bq, function (r, n, i, a) {
    ...
    var Qv = u((XH, $v) => {
        ...
        function Yv(e) {
            ...
            if (Kq(e)) return kq(e, Yv) + "";
            if (zq(e)) return zv ? zv.call(e) : "";
            var t = e + "";
    ...
    var sE = u((kH, oE) => {
        ...
        function _L(e, t, r) {
            ...
            return a || ++n != i ? a : (i = e == null ? 0 : e.length, !!i && hL(i) && EL(o, i) && (vL(e) || pL(e)))
        }
        oE.exports = _L
    });
    var cE = u((KH, uE) => {
    ...
    var PE = u((sj, LE) => {
        ...
        function yP(e, t, r) {
            ...
            if (!n) return -1;
            var i = r == null ? 0 : gP(r);
            return i < 0 && (i = _P(n + i, 0)), EP(e, hP(t, 3), i)
        }
        LE.exports = yP
    });
    var Ao = u((uj, xE) => {
    ...
    var Qn = u(Ne => {
        ...
        var $n = (e, t) => DE ? e() : t;
        Ne.withBrowser = $n;
        var AP = $n(() => (0, SP.default)(["matches", "matchesSelector", "mozMatchesSelector", "msMatchesSelector", "oMatchesSelector", "webkitMatchesSelector"], e => e in Element.prototype));
    ...
    var bo = u((lj, BE) => {
        ...
        function PP(e, t, r, n, i) {
            var a, o, s = 0;
            do o = t + (r - t) / 2, a = Jn(o, n, i) - e, a > 0 ? r = o : t = o; while (Math.abs(a) > NP && ++s < qP);
            return o
        }
        ...
        BE.exports = function (t, r, n, i) {
            ...
            function s(c) {
                for (var f = 0, p = 1, d = Br - 1; p !== d && a[p] <= c; ++p) f += Zn;
                --p;
    ...
    var Ro = u(J => {
        ...
        var ei = MP(bo()),
            ft = 1.70158,
            DP = (0, ei.default)(.25, .1, .25, 1);
        J.ease = DP;
        var FP = (0, ei.default)(.42, 0, 1, 1);
        J.easeIn = FP;
        var GP = (0, ei.default)(0, 0, .58, 1);
        J.easeOut = GP;
        var XP = (0, ei.default)(.42, 0, .58, 1);
        J.easeInOut = XP;
    ...
    var KE = u(nr => {
            ...
            Fx = (e = HE, t = {}) => {
                switch (t.type) {
                    ...
                    case xx: {
                        ...
                        return (0, ti.getIn)(c, [r, n]) !== n && (c = kE(c, n, o, r, a)), No(c, r, s, i, a)
                    }
                    case Mx: {
                        let {
                            elementId: r,
        ...
        function kE(e, t, r, n, i) {
            let a = r === Sx ? (0, ti.getIn)(i, ["config", "target", "objectId"]) : null;
            return (0, ti.mergeIn)(e, [n], {
                id: n,
                ref: t,
                refId: a,
                refType: r
    ...
    var ph = u((Rj, dh) => {
        ...
        function wM(e, t, r) {
            ...
            if (!n) return -1;
            var i = n - 1;
            return r !== void 0 && (i = AM(r), i = r < 0 ? bM(n + i, 0) : RM(i, n - 1)), OM(e, SM(t, 3), i, !0)
        }
        dh.exports = wM
    });
    var Eh = u((wj, vh) => {
    ...
    var gh = u(ri => {
        ...
        function PM(e, t) {
            ...
            for (let i = 0; i < r.length; i++)
                if (!LM.call(t, r[i]) || !hh(e[r[i]], t[r[i]])) return !1;
            return !0
        }
        var xM = PM;
        ri.default = xM
    ...
    var Gh = u(fe => {
        ...
        function Xo({
            ...
            if (Array.isArray(c) && c.length > 0) return c.reduce((M, G) => M.concat(Xo({
                config: {
                    target: G
                },
                event: t,
            ...
            let j = ((a = t == null || (o = t.action) === null || o === void 0 || (s = o.config) === null || s === void 0 ? void 0 : s.affectedElements) !== null && a !== void 0 ? a : {})[R || q] || {},
                re = !!(j.id || j.selector),
                $, x, _, P = t && p(Oh(t.target));
            if (re ? ($ = j.limitAffectedElements, x = P, _ = p(j)) : x = _ = p({
                    id: R,
                    selector: q,
                    selectorGuids: w
                }), t && D) {
                let M = r && (_ || D === !0) ? [r] : d(P);
                if (_) {
                    if (D === YM) return d(_).filter(G => M.some(K => O(G, K)));
                    if (D === yh) return d(_).filter(G => M.some(K => O(K, G)));
                    if (D === Ih) return d(_).filter(G => M.some(K => N(K, G)))
                }
                return M
            }
        ...
        var Sh = /px/,
            oD = (e, t) => t.reduce((r, n) => (r[n.type] == null && (r[n.type] = ED[n.type]), r), e || {}),
            sD = (e, t) => t.reduce((r, n) => (r[n.type] == null && (r[n.type] = hD[n.type] || n.defaultValue || 0), r), e || {});
        ...
        function uD(e, t = {}, r = {}, n, i) {
            ...
            if ((0, ot.isPluginType)(o)) return (0, ot.getPluginOrigin)(o)(t[o]);
            switch (n.actionTypeId) {
                ...
                case qh:
                    return {
                        value: (0, It.default)(parseFloat(a(e, ni)), 1)
                    };
                case ur: {
                    let s = a(e, it),
                        c = a(e, at),
                        f, p;
                    return n.config.widthUnit === Tt ? f = Sh.test(s) ? parseFloat(s) : parseFloat(r.width) : f = (0, It.default)(parseFloat(s), parseFloat(r.width)), n.config.heightUnit === Tt ? p = Sh.test(c) ? parseFloat(c) : parseFloat(r.height) : p = (0, It.default)(parseFloat(c), parseFloat(r.height)), {
                        widthValue: f,
                        heightValue: p
                    }
                }
                ...
                case oi:
                    return {
                        value: (0, It.default)(a(e, ii), r.display)
                    };
                case QM:
        ...
        var cD = (e, t) => (t && (e[t.type] = t.value || 0), e),
            lD = (e, t) => (t && (e[t.type] = t.value || 0), e),
            fD = (e, t, r) => {
                if ((0, ot.isPluginType)(e)) return (0, ot.getPluginConfig)(e)(r, t);
                switch (e) {
                    case zr: {
                        let n = (0, xo.default)(r.filters, ({
                            type: i
                        }) => i === t);
                        return n ? n.value : 0
                    }
                    case Yr: {
                        let n = (0, xo.default)(r.fontVariations, ({
                            type: i
                        }) => i === t);
                        return n ? n.value : 0
                    }
        ...
        function dD({
            ...
            if ((0, ot.isPluginType)(t.actionTypeId)) return (0, ot.getPluginDestination)(t.actionTypeId)(t.config);
            switch (t.actionTypeId) {
                ...
                case ur: {
                    ...
                    if (o === Tt) {
                        let p = n(e, it);
                        i(e, it, ""), c = a(e, "offsetWidth"), i(e, it, p)
                    }
                    if (s === Tt) {
                        let p = n(e, at);
                        i(e, at, ""), f = a(e, "offsetHeight"), i(e, at, p)
                    }
                    return {
                        widthValue: c,
                        heightValue: f
        ...
        function vD(e, t, r, n, i, a, o, s, c) {
            switch (s) {
                ...
                case Nh: {
                    ...
                    if ((0, ot.isPluginType)(f)) return (0, ot.renderPlugin)(f)(c, t, i)
                }
            }
        }
        var Uo = {
        ...
        function yD(e, t, r, n, i) {
            ...
            Pt(e, qe.TRANSFORM_PREFIXED, i), o(e, qe.TRANSFORM_PREFIXED, a), mD(n, r) && o(e, qe.TRANSFORM_STYLE_PREFIXED, HM)
        }

        function ID(e, t, r, n) {
            let i = (0, Mo.default)(t, (o, s, c) => `${o} ${c}(${s}${gD(c,r)})`, ""),
                {
                    setStyle: a
                } = n;
            Pt(e, Hr, n), a(e, Hr, i)
        ...
        function TD(e, t, r, n) {
            let i = (0, Mo.default)(t, (o, s, c) => (o.push(`"${c}" ${s}`), o), []).join(", "),
                {
                    setStyle: a
                } = n;
            Pt(e, jr, n), a(e, jr, i)
        ...
        function wD(e, t, r, n, i, a) {
            ...
            switch (n.actionTypeId) {
                case ur: {
                    ...
                    f !== void 0 && (s === Tt && (s = "px"), Pt(e, it, a), o(e, it, f + s)), p !== void 0 && (c === Tt && (c = "px"), Pt(e, at, a), o(e, at, p + c));
                    break
                }
                case zr: {
                    ID(e, r, n.config, a);
                ...
                case fr: {
                    let s = Go[n.actionTypeId],
                        ...
                        d = r.aValue;
                    Pt(e, s, a), o(e, s, d >= 1 ? `rgb(${c},${f},${p})` : `rgba(${c},${f},${p},${d})`);
                    break
                }
                default: {
                    let {
        ...
        function bh({
            ...
            n.forEach(({
                ...
                let o;
                (0, ot.isPluginType)(i) ? o = (0, ot.clearPlugin)(i): o = Dh({
                    effect: LD,
                    actionTypeId: i,
                    elementApi: r
                }), Xo({
        ...
        function qD(e, t, r) {
            ...
            if (a === ur) {
                ...
                o.widthUnit === Tt && n(e, it, ""), o.heightUnit === Tt && n(e, at, "")
            }
            i(e, ir) && Dh({
                effect: Mh,
                actionTypeId: a,
        ...
        function LD(e, t, r) {
            ...
            Mh(e, t, r), n(e, t, ""), t === qe.TRANSFORM_PREFIXED && n(e, qe.TRANSFORM_STYLE_PREFIXED, "")
        }
        ...
        function xD({
            ...
            let {
                actionItemGroups: n,
                continuousParameterGroups: i
            } = e, a = [], o = s => (a.push((0, _h.mergeIn)(s, ["config"], {
                delay: 0,
                duration: 0
            })), s.id === t);
            return n && n.some(({
    ...
    var Bh = u(ui => {
        ...
        var Xh = xe(),
            ...
            rF = (e, t) => {
                ...
                for (let H = 0, {
                    ...
                    if (H === 0 && (I = $[0]), R >= re) {
                        ...
                        let x = i[H + 1],
                            _ = x && R !== re;
                        q = _ ? x.actionItems[0] : null, _ && (w = re / 100, C = (x.keyframe - re) / 100)
                    }
                }
                let D = {};
                if (I && !q)
            ...
            nF = (e, t) => {
                ...
                d != null && (N = d), b = v ? ? b, o === JD ? N = 0 : (a || S) && (N = b = 0);
                let {
                    now: R
                } = t.payload;
                if (r && n) {
                    ...
                    return p.length && (D = p.reduce((H, j) => {
                        let re = f[j],
                            ...
                            _ = (parseFloat(re) - $) * w + $;
                        return H[j] = _, H
                    }, {})), C.current = D, C.position = q, q === 1 && (C.active = !1, C.complete = !0), (0, pr.merge)(e, C)
                }
                return e
            },
                ...
                switch (t.type) {
                    ...
                    case zD: {
                        let {
                            ...
                            actionTypeId: j
                        } = i, re = eF(j), $ = tF(re, j), x = Object.keys(v).filter(P => v[P] != null), {
                            easing: _
                        } = i.config;
                        return (0, pr.set)(e, r, {
                            id: r,
    ...
    var Wh = u(ci => {
        ...
        var aF = xe(),
            {
                IX2_RAW_DATA_IMPORTED: oF,
                IX2_SESSION_STOPPED: sF,
                IX2_PARAMETER_CHANGED: uF
            } = aF.IX2EngineActionTypes,
            cF = (e = {}, t) => {
                switch (t.type) {
                    case oF:
    ...
    var jh = u((Mj, $r) => {
        ...
        $r.exports = yF, $r.exports.__esModule = !0, $r.exports.default = $r.exports
    });
    var Kh = u((Dj, kh) => {
        var IF = gt(),
            TF = Ae(),
    ...
    var lg = u((Vj, cg) => {
        ...
        function a1(e) {
            if (e == null) return 0;
            if (e1(e)) return t1(e) ? r1(e) : e.length;
            var t = JF(e);
    ...
    var Ig = u((kj, yg) => {
        ...
        function I1(e, t, r, n) {
            ...
            for (var i = -1, a = t.length, o = a - 1, s = e; s != null && ++i < a;) {
                ...
                if (i != o) {
                    var p = s[c];
                    f = n ? n(p, c, s) : void 0, f === void 0 && (f = _g(p) ? p : _1(t[i + 1]) ? [] : {})
                }
                h1(s, c, f), s = s[c]
            }
            return e
    ...
    var xg = u((Jj, Pg) => {
        ...
        function $1(e, t) {
            ...
            return t = K1(t), z1(e, r, function (n, i) {
                return t(n, i[0])
            })
        }
        Pg.exports = $1
    ...
    var Gg = u((tk, Fg) => {
        ...
        function p2(e) {
            if (e == null) return !0;
            if (a2(e) && (i2(e) || typeof e == "string" || typeof e.splice == "function" || o2(e) || u2(e) || n2(e))) return !e.length;
            var t = r2(e);
    ...
    var Ug = u((rk, Xg) => {
        ...
        function g2(e, t) {
            var r = {};
            return t = h2(t, 3), E2(e, function (n, i, a) {
                v2(r, i, t(n, i, a))
            }), r
        }
        Xg.exports = g2
    ...
    var Qg = u((sk, $g) => {
        ...
        function L2(e, t, r) {
            ...
            t = Yg(t) || 0, w2(r) && (p = !!r.leading, d = "maxWait" in r, a = d ? N2(Yg(r.maxWait) || 0, t) : a, v = "trailing" in r ? !!r.trailing : v);

            function y(C) {
                var D = n,
                    H = i;
                return n = i = void 0, f = C, o = e.apply(H, D), o
            }

            function S(C) {
                return f = C, s = setTimeout(b, t), p ? y(C) : o
            }
            ...
            function R(C) {
                return s = void 0, v && n ? y(C) : (n = i = void 0, o)
            }
            ...
            function w() {
                var C = ko(),
                    D = N(C);
                if (n = arguments, i = this, c = C, D) {
                    if (s === void 0) return S(c);
                    if (d) return clearTimeout(s), s = setTimeout(b, t), y(c)
                }
    ...
    var Jg = u((uk, Zg) => {
        ...
        function D2(e, t, r) {
            ...
            return x2(r) && (n = "leading" in r ? !!r.leading : n, i = "trailing" in r ? !!r.trailing : i), P2(e, t, {
                leading: n,
                maxWait: t,
                trailing: i
            })
    ...
    var fi = u(te => {
        ...
        var e_ = F2(Nr()),
            ...
            G2 = xt(),
            {
                ...
                IX2_SESSION_INITIALIZED: U2,
                IX2_SESSION_STARTED: V2,
                IX2_SESSION_STOPPED: B2,
                IX2_PREVIEW_REQUESTED: W2,
                IX2_PLAYBACK_REQUESTED: H2,
                IX2_STOP_REQUESTED: j2,
                IX2_CLEAR_REQUESTED: k2,
                IX2_EVENT_LISTENER_ADDED: K2,
                IX2_TEST_FRAME_RENDERED: z2,
                IX2_EVENT_STATE_CHANGED: Y2,
                IX2_ANIMATION_FRAME_CHANGED: $2,
                IX2_PARAMETER_CHANGED: Q2,
                IX2_INSTANCE_ADDED: Z2,
                IX2_INSTANCE_STARTED: J2,
    ...
    var m_ = u((_k, T_) => {
        ...
        function nX(e, t, r) {
            return t = I_(t === void 0 ? e.length - 1 : t, 0),
                function () {
                    for (var n = arguments, i = -1, a = I_(n.length - t, 0), o = Array(a); ++i < a;) o[i] = n[t + i];
                    i = -1;
    ...
    var hi = u((Ck, j_) => {
        ...
        function Ei(e) {
            this.__wrapped__ = e, this.__actions__ = [], this.__dir__ = 1, this.__filtered__ = !1, this.__iteratees__ = [], this.__takeCount__ = CX, this.__views__ = []
        }
    ...
    var Z_ = u((Lk, Q_) => {
        ...
        function gi(e) {
            if (GX(e) && !FX(e) && !(e instanceof MX)) {
                ...
                if (VX.call(e, "__wrapped__")) return XX(e)
            }
            return new $_(e)
        }
    ...
    var iy = u((xk, ny) => {
        ...
        function tU(e) {
            return KX(function (t) {
                ...
                for (e && t.reverse(); n--;) {
                    var a = t[n];
                    if (typeof a != "function") throw new TypeError($X);
                    if (i && !o && Qo(a) == "wrapper") var o = new ty([], !0)
                }
                for (n = o ? n : r; ++n < r;) {
                    a = t[n];
                    var s = Qo(a),
                ...
                return function () {
                    var f = arguments,
                        p = f[0];
                    if (o && f.length == 1 && YX(p)) return o.plant(p).value();
    ...
    var ly = u((Fk, cy) => {
        ...
        function oU(e, t, r) {
            return r === void 0 && (r = t, t = void 0), r !== void 0 && (r = Zo(r), r = r === r ? r : 0), t !== void 0 && (t = Zo(t), t = t === t ? t : 0), aU(Zo(e), t, r)
        }
        cy.exports = oU
    });
    var wy = u(mi => {
        ...
        var Ge = Ti(Nr()),
            ...
            Qr = (() => {
                ...
                return () => ({
                    ...
                    stiffScrollTop: (0, cU.default)(e ? window.pageYOffset : r.scrollTop, 0, r.scrollHeight - window.innerHeight),
            ...
            FU = e => {
                let {
                    ...
                    clientWidth: n,
                    clientHeight: i
                } = Qr(), a = r.scrollOffsetValue, c = r.scrollOffsetUnit === "PX" ? a : i * (a || 0) / 100;
            ...
            Ry = e => (t, r) => {
                let {
                    type: n
                } = t.nativeEvent, i = [es, Oy].indexOf(n) !== -1 ? n === es : r.isActive, a = (0, Ge.default)({}, r, {
                    isActive: i
                });
            ...
            Ey = e => (t, r = {}) => {
                let {
                    ...
                    scrollOffsetValue: c,
                    scrollOffsetUnit: f
                } = o, p = f === "PX", d = i - a, v = Number((n / d).toFixed(2));
                if (r && r.percentTop === v) return r;
                let y = (p ? c : a * (c || 0) / 100) / d,
                    S, O, N = 0;
                r && (S = v > r.percentTop, O = r.scrollingDown !== S, N = O ? v : r.anchorTop);
            ...
            gy = (0, Ge.default)({}, rs, {
                handler: GU((e, t) => {
                    ...
                    return !o[n.action.config.autoStopEventId] && t.triggered ? t : n.eventTypeId === Iy === r ? (De(e), (0, Ge.default)({}, t, {
                        triggered: !0
                    })) : t
                })
            }),
            ...
            BU = {
                ...
                [AU]: {
                    ...
                    handler: ({
                        ...
                        let {
                            ...
                            pageX: y = a.pageX,
                            pageY: S = a.pageY
                        } = n, O = s === "X_AXIS", N = n.type === "mouseout", b = p / 100, R = c, I = !1;
                        switch (o) {
                        ...
                        return N && (b > 1 - _y || b < _y) && (b = Math.round(b)), (o !== Mt.EventBasedOn.ELEMENT || I || I !== a.elementHovered) && (b = f ? 1 - b : b, e.dispatch((0, _i.parameterChanged)(R, b))), {
                            elementHovered: I,
                            clientX: d,
                            clientY: v,
                            pageX: y,
                ...
                [qU]: {
                    ...
                    handler: ({
                        ...
                        s = n ? 1 - s : s, e.dispatch((0, _i.parameterChanged)(r, s))
                    }
                },
                [wU]: {
                    types: ts,
                    handler: ({
                        ...
                        if (p === Mt.EventBasedOn.VIEWPORT) {
                            let q = I ? a / s : o / c;
                            return q !== i.scrollPercent && t.dispatch((0, _i.parameterChanged)(v, q)), {
                                scrollPercent: q
                            }
                        } else {
                            let q = dy(n, v),
                            ...
                            return _ !== i.scrollPercent && t.dispatch((0, _i.parameterChanged)(q, _)), {
                                scrollPercent: _
                            }
                        }
                    }
    ...
    var ns = u(Ot => {
        ...
        function bi({
            ...
            })), r && (NV(e), AV(), e.getState().ixSession.hasDefinedMediaQueries && yV(e)), e.dispatch((0, ge.sessionStarted)()), bV(e, n))
        }
        ...
        function bV(e, t) {
            let r = n => {
                ...
                i.active && (e.dispatch((0, ge.animationFrameChanged)(n, a)), t ? IV(e, r) : requestAnimationFrame(r))
            };
        ...
        function Ri(e) {
            ...
            if (t.active) {
                ...
                r.forEach(RV), e.dispatch((0, ge.sessionStopped)())
            }
        }
        ...
        function wV({
            ...
            b.forEach(q => {
                ...
                let C = O[w],
                    D = (0, mt.default)(C, "[0].actionItems[0]", {}),
                    {
                        actionTypeId: H
                    } = D,
        ...
        var PV = (e, t) => (0, zU.default)((0, $U.default)(e, t), YU.default),
            xV = (e, t) => {
                (0, en.default)(e, (r, n) => {
                    r.forEach((i, a) => {
                        let o = n + as + a;
        ...
        function DV({
            ...
            (0, en.default)(s, (d, v) => {
                ...
                pV(N, a.mediaQueryKeys) || t.dispatch((0, ge.mediaQueriesDefined)()), S.actionTypeId === Ke.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION && (Array.isArray(y.config) ? y.config : [y.config]).forEach(I => {
                    let {
                        continuousParameterGroupId: q
                    } = I, w = (0, mt.default)(o, `${b}.continuousParameterGroups`, []), C = (0, kU.default)(w, ({
                        id: j
                    }) => j === q), D = (I.smoothing || 0) / 100, H = (I.restingState || 0) / 100;
                    C && d.forEach((j, re) => {
                        let $ = O + as + re;
                        wV({
                            store: t,
            ...
            let c = d => {
                    ...
                    xV(s, (y, S, O) => {
                        ...
                        if (!Ai(I, v.mediaQueryKey)) return;
                        let q = (w = {}) => {
                            let C = i({
                                store: t,
                                element: y,
                            ...
                            vV(C, b) || t.dispatch((0, ge.eventStateChanged)(O, C))
                        };
                ...
                p = ({
                    ...
                    v.split(" ").filter(Boolean).forEach(S => {
                        let O = y ? f : c;
                        d.addEventListener(S, O), t.dispatch((0, ge.eventListenerAdded)(d, [S, O]))
                    })
                };
        ...
        function Dy({
            ...
            if (c && c.useFirstGroupAsInitialState) {
                let f = (0, mt.default)(c, "actionItemGroups[0].actionItems", []),
                    p = (0, mt.default)(s, "mediaQueries", n.mediaQueryKeys);
                if (!Ai(p, i.mediaQueryKey)) return;
                f.forEach(d => {
                    var v;
                    let {
                        config: y,
                        actionTypeId: S
                    } = d, O = (y == null || (v = y.target) === null || v === void 0 ? void 0 : v.useEventTarget) === !0 ? {
                        target: s.target,
                        targets: s.targets
                    } : y, N = Si({
                        config: O,
        ...
        function Fy({
            ...
            (0, en.default)(t, r => {
                if (!r.continuous) {
                    ...
                    ds(r, e), i && e.dispatch((0, ge.actionListPlaybackChanged)({
                        actionListId: n,
                        isPlaying: !1
                    }))
                }
        ...
        function cs({
            ...
            let {
                ixInstances: a,
                ixSession: o
            } = e.getState(), s = o.hasBoundaryNodes && r ? me.getClosestElement(r, Oi) : null;
            (0, en.default)(a, c => {
                let f = (0, mt.default)(c, "actionItem.config.target.boundaryMode"),
                    p = n ? c.eventStateKey === n : !0;
                if (c.actionListId === i && c.eventId === t && p) {
                    if (s && f && !me.elementContains(s, c.element)) return;
                    ds(c, e), c.verbose && e.dispatch((0, ge.actionListPlaybackChanged)({
                        actionListId: i,
                        isPlaying: !1
                    }))
                }
        ...
        function ls({
            ...
            } = v, S = (0, mt.default)(f, `actionLists.${i}`, {}), {
                actionItemGroups: O,
                useFirstGroupAsInitialState: N
            } = S;
            if (!O || !O.length) return !1;
            a >= O.length && (0, mt.default)(v, "config.loop") && (a = 0), a === 0 && N && a++;
            let R = (a === 0 || a === 1 && N) && is((c = v.action) === null || c === void 0 ? void 0 : c.actionTypeId) ? v.config.delay : void 0,
                I = (0, mt.default)(O, [a, "actionItems"], []);
            if (!I.length || !Ai(y, p.mediaQueryKey)) return !1;
        ...
        function fs(e) {
            ...
            let {
                ...
                refState: R
            } = S[b] || {}, I = me.getRefType(a), q = O.reducedMotion && Ke.ReducedMotionTypes[o.actionTypeId], w;
            ...
            if (r.dispatch((0, ge.instanceAdded)((0, HU.default)({
                    instanceId: y,
                    elementId: b,
                    origin: C,
                    refType: I,
                    skipMotion: q,
                    skipToValue: w
                }, i))), Gy(document.body, "ix2-animation-started", y), s) {
                GV(r, y);
                return
            }
            Dt({
                ...
                onChange: Xy
            }), v && r.dispatch((0, ge.instanceStarted)(y, O.tick))
        }
        ...
        function ds(e, t) {
            ...
            o === Ly && fV(a, n, me), t.dispatch((0, ge.instanceRemoved)(e.id))
        }
        ...
        function Xy(e, t) {
            ...
            if (Ai(D, q.mediaQueryKey) && (n || r || i)) {
                if (f || c === tV && i) {
                    t.dispatch((0, ge.elementStateChanged)(a, s, f, o));
                    let {
                        ixElements: H
                    } = t.getState(), {
                        ref: j,
                ...
                if (i) {
                    if (O) {
                        ...
                        b && !H && t.dispatch((0, ge.actionListPlaybackChanged)({
                            actionListId: S,
                            isPlaying: !1
                        }))
                    }
    ...
    var Vy = u(dt => {
        ...
        var VV = Wa(),
            ...
            WV = XV(fi());
        dt.actions = WV;
        var wi = (0, VV.createStore)(BV.default);
        dt.store = wi;

        function HV(e) {
            e() && (0, ps.observeRequests)(wi)
        }
    ...
    var Ky = u((Bk, ky) => {
        ...
        vr.define("links", ky.exports = function (e, t) {
            ...
            function y() {
                i = a && vr.env("design"), v = vr.env("slug") || o.pathname || "", vr.scroll.off(O), d = [];
                for (var b = document.links, R = 0; R < b.length; ++R) S(b[R]);
                d.length && (vr.scroll.on(O), O())
            }
    ...
    var Yy = u((Wk, zy) => {
        ...
        Ci.define("scroll", zy.exports = function (e) {
            ...
            function I(x, _) {
                ...
                switch (_) {
                    case "add":
                        P = x.attr("tabindex"), P ? x.attr("data-wf-tabindex-swap", P) : x.attr("tabindex", "-1");
                        break;
                    case "remove":
                        P = x.attr("data-wf-tabindex-swap"), P ? (x.attr("tabindex", P), x.removeAttr("data-wf-tabindex-swap")) : x.removeAttr("tabindex");
                        break
                }
            ...
            function q(x) {
                ...
                if (!(Ci.env("design") || window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(_.className))) {
                    ...
                    if (P !== "") {
                        var M = e(P);
                        M.length && (x && (x.preventDefault(), x.stopPropagation()), w(P, x), window.setTimeout(function () {
                            C(M, function () {
            ...
            function C(x, _) {
                ...
                if (P !== M) {
                    var G = H(x, P, M),
                        ...
                        Z = function () {
                            var L = Date.now() - K;
                            window.scroll(0, j(P, M, L, G)), L <= G ? s(Z) : typeof _ == "function" && _()
                        };
                    s(Z)
                }
            }
            ...
            function $() {
                ...
                a.on(_, d, q), a.on(x, p, function (P) {
                    P.preventDefault()
        ...
        kV.define("touch", $y.exports = function (e) {
            ...
            function n(a) {
                var o = !1,
                    ...
                    f, p;
                a.addEventListener("touchstart", d, !1), a.addEventListener("touchmove", v, !1), a.addEventListener("touchend", y, !1), a.addEventListener("touchcancel", S, !1), a.addEventListener("mousedown", d, !1), a.addEventListener("mousemove", v, !1), a.addEventListener("mouseup", y, !1), a.addEventListener("mouseout", S, !1);

                function d(N) {
                    var b = N.touches;
                    b && b.length > 1 || (o = !0, b ? (s = !0, f = b[0].clientX) : f = N.clientX, p = f)
                }
                ...
                function v(N) {
                    if (o) {
                        ...
                        var b = N.touches,
                            ...
                            I = R - p;
                        p = R, Math.abs(I) > c && r && String(r()) === "" && (i("swipe", N, {
                ...
                function O() {
                    a.removeEventListener("touchstart", d, !1), a.removeEventListener("touchmove", v, !1), a.removeEventListener("touchend", y, !1), a.removeEventListener("touchcancel", S, !1), a.removeEventListener("mousedown", d, !1), a.removeEventListener("mousemove", v, !1), a.removeEventListener("mouseup", y, !1), a.removeEventListener("mouseout", S, !1), a = null
                }
                this.destroy = O
            }
    ...
    var eI = u((kk, Jy) => {
        ...
        Ni.define("forms", Jy.exports = function (e, t) {
            ...
            function R() {
                c = e("html").attr("data-wf-site"), S = "https://webflow.com/api/v1/form/" + c, o && S.indexOf("https://webflow.com") >= 0 && (S = S.replace("https://webflow.com", "https://formdata.webflow.com")), O = `${S}/signFile`, i = e(s + " form"), i.length && i.each(I)
            }
            ...
            function q() {
                y = !0, n.on("submit", s + " form", function (oe) {
                    var z = e.data(this, s);
            ...
            function _(L) {
                ...
                oe = Y.substring(oe, Y.indexOf("&", oe)), B["b_" + ae + "_" + oe] = "", e.ajax({
                    ...
                    L.success = z.result === "success" || /already/.test(z.msg), L.success || console.info("MailChimp error: " + z.msg), P(L)
                }).fail(function () {
                    P(L)
                })
            }
            ...
            function G(L, V) {
                ...
                var B, X = e(V.fileUploads[L]),
                    ...
                    qi = _e.attr("data-w-generic-error");
                if (v || pe.on("click keydown", function (h) {
                        h.type === "keydown" && h.which !== 13 && h.which !== 32 || (h.preventDefault(), z.click())
                    }), pe.find(".w-icon-file-upload-icon").attr("aria-hidden", "true"), Er.find(".w-icon-file-upload-remove").attr("aria-hidden", "true"), v) z.on("click", function (h) {
                    h.preventDefault()
                    ...
                    Er.on("click keydown", function (h) {
                        ...
                        z.removeAttr("data-value"), z.val(""), hr.html(""), F.toggle(!0), ae.toggle(!1), pe.focus()
                    }), z.on("change", function (h) {
                        B = h.target && h.target.files && h.target.files[0], B && (F.toggle(!1), oe.toggle(!1), Y.toggle(!0), Y.focus(), hr.text(B.name), T() || C(V), V.fileUploads[L].uploading = !0, K(B, E))
                    });
                ...
                function l(h) {
                    var m = h.responseJSON && h.responseJSON.msg,
                        W = qi;
                    typeof m == "string" && m.indexOf("InvalidFileTypeError") === 0 ? W = Ye : typeof m == "string" && m.indexOf("MaxFileSizeError") === 0 && (W = gr), _e.text(W), z.removeAttr("data-value"), z.val(""), Y.toggle(!1), F.toggle(!0), oe.toggle(!0), oe.focus(), V.fileUploads[L].uploading = !1, T() || w(V)
                }
                ...
                function g(h) {
                    if (h) return l(h);
                    Y.toggle(!1), ae.css("display", "inline-block"), ae.focus(), V.fileUploads[L].uploading = !1, T() || w(V)
                }
...
Webflow.require('ix2').init({
    "events": {
        ...
        "e-4": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "selector": ".boxed-img.project-link",
                "originalId": "644388137e177f45333168e4|69cb8d90-01a1-b032-938d-88d3f07f1b2a",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".boxed-img.project-link",
        ...
        "e-9": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "selector": ".project-btm__w",
                "originalId": "644388137e177f42b13168f7|a6a971e2-e3dd-1a15-401d-b87f50acf3ce",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".project-btm__w",
        ...
        "e-11": {
            ...
            "target": {
                "selector": ".dot-btn",
                "originalId": "644388137e177f1e433168f1|a41ac4c9-ba39-1517-dce1-4244d0c7a345",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".dot-btn",
        ...
        "e-13": {
            ...
            "target": {
                "selector": ".main-btn",
                "originalId": "644388137e177f45333168e4|64c15106-2946-4ded-5fac-7c0313e41c59",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".main-btn",
        ...
        "e-15": {
            ...
            "target": {
                "selector": ".menu-btn",
                "originalId": "78513c41-f34c-246b-323b-19b351dbbd0d",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".menu-btn",
        ...
        "e-21": {
            ...
            "target": {
                ...
                "originalId": "644388137e177f45333168e4|01c2e0b1-9314-8bd3-7295-d706f800d960",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".horizontal-line",
        ...
        "e-28": {
            ...
            "target": {
                "selector": ".img-cover",
                "originalId": "644388137e177f45333168e4|45dcb237-8059-c85f-ccd2-f948ff386ec5",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".img-cover",
        ...
        "e-34": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "644388137e177f45333168e4|ccb5fb0a-e0cd-96c0-a6e0-5b27ed9ea850",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-36": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "644388137e177f58083168f2|275829ad-1566-a989-7c4c-fbd69440b34a",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-37": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "644388137e177f58083168f2|ffe0979b-f9f7-a14a-d4e3-c468e30b38a2",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-38": {
            ...
            "target": {
                "selector": ".hero-img",
                "originalId": "644388137e177f42b13168f7|95845cc5-df14-37d9-374d-7cf8aaca612d",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".hero-img",
        ...
        "e-39": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "selector": ".project-img__w",
                "originalId": "644388137e177f42b13168f7|e5399440-ddbc-98de-1f6c-078ed1329320",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".project-img__w",
        ...
        "e-40": {
            ...
            "target": {
                "id": "644388137e177f42b13168f7|3453fa20-ba46-23d2-2e98-9af3314dfc8a",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-41": {
            ...
            "mediaQueries": ["main", "medium", "small"],
            "target": {
                "id": "644388137e177f42b13168f7|e5399440-ddbc-98de-1f6c-078ed1329322",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-42": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "selector": ".menu-link__w",
                "originalId": "fa0aeed7-ba9f-f9de-0aaa-3b0665b63a6b",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".menu-link__w",
        ...
        "e-44": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "selector": ".section.is--black.is--footer",
                "originalId": "056e7067-ea99-8f1c-9966-bd6571b65a1e",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".section.is--black.is--footer",
        ...
        "e-48": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "selector": ".home-hero__img-h",
                "originalId": "644388137e177f45333168e4|c4e018e9-2892-cb28-1405-3367bbce4f2c",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".home-hero__img-h",
        ...
        "e-49": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "644388137e177f45333168e4|5ab002f8-af1a-7713-7102-5a5dd48adcef",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-50": {
            ...
            "mediaQueries": ["main", "medium", "small"],
            "target": {
                "id": "644388137e177f42b13168f7|36a3a366-5f1a-7500-a7d3-7b4f8becc52a",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-51": {
            ...
            "mediaQueries": ["main", "medium", "small"],
            "target": {
                "id": "644388137e177f42b13168f7|172fcf11-6cc2-c904-ec69-0d108c04fbdf",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
            ...
            "createdOn": 1683790590557
        }
    },
    "actionLists": {
        "a": {
            "id": "a",
            "title": "Custom Cursor – follow mouse",
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "selector": ".cursor-element",
                                "selectorGuids": ["18d27838-8c9d-8be4-f2a5-b688408bf034"]
                            },
                            "xValue": -50,
                            "xUnit": "vw",
                            "yUnit": "PX",
            ...
            "createdOn": 1678965584476
        },
        "a-30": {
            "id": "a-30",
            "title": "Project – swiper – hover in",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-30-n",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": true,
                            "id": "644388137e177f45333168e4|69cb8d90-01a1-b032-938d-88d3f07f1b2a"
                        },
                        "xValue": 1,
                        "yValue": 1,
                        "locked": true
                    ...
                    "config": {
                        ...
                        "target": {
                            "selector": ".swiper-img",
                            "selectorGuids": ["981a794e-eeb7-85b5-ae0b-74a7fd917f3d"]
                        },
                        "xValue": 1,
                        "yValue": 1,
                        "locked": true
            ...
            "createdOn": 1679068577824
        },
        "a-31": {
            "id": "a-31",
            "title": "Project – swiper – hover out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-31-n",
                    "actionTypeId": "TRANSFORM_SCALE",
        ...
        "a-6": {
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                ...
                                "selector": ".project-btm__list",
                                "selectorGuids": ["90737941-1661-6b44-a2de-fc0d4f4895c9"]
                            },
                            "xValue": 65,
                            "xUnit": "em",
                            "yUnit": "PX",
            ...
            "createdOn": 1680086432616
        },
        "a-7": {
            "id": "a-7",
            "title": "Dotted button - hover in",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-7-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".dot-btn__arrow",
                            "selectorGuids": ["f330d60b-d827-aadd-b618-0f9bc4035563"]
                        },
                        "xValue": 110,
                        "xUnit": "%",
                        "yUnit": "PX",
            ...
            "useFirstGroupAsInitialState": false,
            "createdOn": 1680093001949
        },
        "a-8": {
            "id": "a-8",
            "title": "Dotted button - hover out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-8-n",
                    "actionTypeId": "TRANSFORM_MOVE",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".main-btn__arrow",
                            "selectorGuids": ["17e38241-d875-923a-b2e2-eb85e440f55b"]
                        },
                        "xValue": 110,
                        "xUnit": "%",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".main-btn__line",
                            "selectorGuids": ["7565dfd6-21ad-73a3-985c-8b2130e6f3bd"]
                        },
                        "xValue": 100,
                        "xUnit": "%",
                        "yUnit": "PX",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "b51d5b2a-4412-3ff3-ba1b-627222e209bf"
                        },
                        "widthValue": 100,
                        "widthUnit": "%",
                        "heightUnit": "PX",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "b51d5b2a-4412-3ff3-ba1b-627222e209c5"
                        },
                        "xValue": 1,
                        "locked": false
                    }
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "b51d5b2a-4412-3ff3-ba1b-627222e209c6"
                        },
                        "zValue": 0,
                        "xUnit": "DEG",
                        "yUnit": "DEG",
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "b51d5b2a-4412-3ff3-ba1b-627222e209c4"
                        },
                        "yValue": 0,
                        "xUnit": "PX",
                        "yUnit": "em",
        ...
        "a-15": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": true,
                            "id": "644388137e177f45333168e4|01c2e0b1-9314-8bd3-7295-d706f800d960"
                        },
                        "xValue": 0,
                        "locked": false
                    }
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1680605620413
        },
        "a-16": {
            "id": "a-16",
            "title": "Horizontal line – Out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-16-n-2",
                    "actionTypeId": "TRANSFORM_SCALE",
        ...
        "a-21": {
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                "useEventTarget": true,
                                "id": "644388137e177f45333168e4|45dcb237-8059-c85f-ccd2-f948ff386ec5"
                            },
                            "yValue": 0,
                            "xUnit": "PX",
                            "yUnit": "%",
            ...
            "createdOn": 1680618391779
        },
        "a-18": {
            "id": "a-18",
            "title": "Trail image – main",
            "continuousParameterGroups": [{
                "id": "a-18-p",
                "type": "MOUSE_X",
                "parameterLabel": "Mouse X",
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "selector": ".trail-img.is-main",
                                "selectorGuids": ["728aaebd-9631-ab9e-5035-26d5cbc70b5f", "f284cc89-4aef-c2f6-11c3-687650a9747b"]
                            },
                            "xValue": -50,
                            "xUnit": "vw",
                            "yUnit": "PX",
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "selector": ".trail-img.is-2",
                                "selectorGuids": ["728aaebd-9631-ab9e-5035-26d5cbc70b5f", "3417af3f-affd-f1df-8e5d-c21fb7a244fe"]
                            },
                            "xValue": -50,
                            "xUnit": "vw",
                            "yUnit": "PX",
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "selector": ".trail-img.is-3",
                                "selectorGuids": ["728aaebd-9631-ab9e-5035-26d5cbc70b5f", "466d328a-d8c5-a863-d1f0-37c67a47510e"]
                            },
                            "xValue": -50,
                            "xUnit": "vw",
                            "yUnit": "PX",
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "selector": ".trail-img.is-4",
                                "selectorGuids": ["728aaebd-9631-ab9e-5035-26d5cbc70b5f", "5d883769-e9d0-355f-d1d7-92d36c84579b"]
                            },
                            "xValue": -50,
                            "xUnit": "vw",
                            "yUnit": "PX",
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "selector": ".trail-img.is-5",
                                "selectorGuids": ["728aaebd-9631-ab9e-5035-26d5cbc70b5f", "2592f43c-0468-ec7b-7d9b-1897731a11ff"]
                            },
                            "xValue": -50,
                            "xUnit": "vw",
                            "yUnit": "PX",
        ...
        "a-19": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 0,
                        "target": {
                            "selector": ".trail-img__w",
                            "selectorGuids": ["f52ae73b-4c5d-7286-8f90-f9bc74700c2d"]
                        },
                        "value": "none"
                    }
                }, {
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1680611208051
        },
        "a-20": {
            "id": "a-20",
            "title": "Hide Trail image",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-20-n-2",
                    "actionTypeId": "STYLE_OPACITY",
        ...
        "a-28": {
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                "useEventTarget": "CHILDREN",
                                "selector": ".img-fill",
                                "selectorGuids": ["6105a614-0ed7-558f-57b5-22f004331da2"]
                            },
                            "yValue": 0,
                            "xUnit": "PX",
                            "yUnit": "%",
            ...
            "createdOn": 1680733607680
        },
        "a-29": {
            "id": "a-29",
            "title": "About img - center",
            "continuousParameterGroups": [{
                "id": "a-29-p",
                "type": "SCROLL_PROGRESS",
                "parameterLabel": "Scroll",
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                ...
                                "selectorGuids": ["7baee4e4-412c-5ae5-226f-6c32bdd817a5"]
                            },
                            "yValue": 5,
                            "xUnit": "PX",
                            "yUnit": "%",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".menu-link__line",
                            "selectorGuids": ["41274bc8-3885-540f-f732-e277806e7b69"]
                        },
                        "xValue": 0,
                        "locked": false
                    }
        ...
        "a-38": {
            "id": "a-38",
            "title": "Footer scroll in - hide nav",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-38-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    "config": {
                        ...
                        "target": {
                            "selector": ".navbar-w",
                            "selectorGuids": ["41da09c9-aa8d-37c5-89e8-54ff806cca51"]
                        },
                        "yValue": 0,
                        "xUnit": "PX",
                        "yUnit": "%",
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1681387717662
        },
        "a-39": {
            "id": "a-39",
            "title": "Footer scroll out - show nav",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-39-n-3",
                    "actionTypeId": "TRANSFORM_MOVE",
        ...
        "a-41": {
            ...
            "createdOn": 1681767661067
        },
        "a-42": {
            "id": "a-42",
            "title": "Project image -- tall left",
            "continuousParameterGroups": [{
                "id": "a-42-p",
                "type": "SCROLL_PROGRESS",
                "parameterLabel": "Scroll",
